...
file <- "Krisai1996Tab7taxon2standard.txt"
x <- read.verbatim(file, "Aufnahme Nr.", verbose = FALSE, layers = "@")
X0 <- species(x)

#	and footer taxa
file <- "Krisai1996Tab7FooterSpecies.csv"
X1 <- species(file, sep = ";")[, 1:4]

X <- rbind(X0, X1)

#   sites data including coordinates
file <- "~/Documents/vegsoup-data/krisai1996/krisai1996Tab7Locations.csv"
